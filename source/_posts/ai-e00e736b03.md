...
tags:
  - AI
  - InfoQ 中文
excerpt: "Expedia Group开源了mockql-rs(https://medium.com/expedia-group-tech/focus-on-the-feature-not-the-fixture"
source_url: "https://www.infoq.cn/article/Su2betkPUhxX0JTVazBi?utm_source=rss&utm_medium=article"
---
> 来源：InfoQ 中文　|　原发布：2026-09-01　|　采集：2026-09-02 07:40:59

## 正文

Expedia Group[开源了mockql-rs](https://medium.com/expedia-group-tech/focus-on-the-feature-not-the-fixture-genai-powered-graphql-mocks-ea069670af02)，这是一个 Rust CLI 工具，可以在请求时从 LLM 生成 GraphQL 的模拟响应。这是过去六个月内第三次公开尝试解决这一问题，前两次分别是 Airbnb 在 4 月推出的 @generateMock 指令和 2 月份开放的[GraphQL基金会RFC](https://rfcs.graphql.org/rfcs/MockSpec/)。这三种方案采用了显著不同的设计，其中两种使用相同的指令名称但含义并不相同。
...
（代码示例来自 Expedia Group 的技术[博客文章](https://medium.com/expedia-group-tech/focus-on-the-feature-not-the-fixture-genai-powered-graphql-mocks-ea069670af02)，并进行了删减。）
...
RFC 采取了第三种立场。它在操作而不是字段上定义 @mock，使用名称参数在命名响应之间进行选择，并要求符合规范的客户端返回模拟数据而无需发出任何网络请求。模拟响应位于与源文件相邻的\_\_graphql\_mocks\_\_目录中，以操作来进行命名，带有保留的\_\_default\_\_键和在重新生成时使用的可选描述。LLM 生成仅作为推荐策略出现，而不是作为一种机制。
...
查看英文原文：[LLM-Generated GraphQL Mocks Arrive at Airbnb and Expedia, While the Spec Lags Behind](https://www.infoq.com/news/2026/08/graphql-llm-mocking-spec/)


---

> 本文正文由程序自动抓取自公开网页/RSS，版权归原作者与来源站点所有；如有侵权请联系删除。原文出处：InfoQ 中文（https://www.infoq.cn/article/Su2betkPUhxX0JTVazBi?utm_source=rss&utm_medium=article）。