...
source_url: "https://www.infoq.cn/article/lRSUjSdeaHMzTTycosyT?utm_source=rss&utm_medium=article"
---
...
飞猪 & 技术专家王浩男已确认出席 “[Loop Engineering](https://qcon.infoq.cn/2026/shanghai/track/1964)” 专题，并发表题为**《**[飞猪 AI Native 交付大脑：用超级流程重构需求交付](https://qcon.infoq.cn/2026/shanghai/presentation/7263)**》**的主题分享。AI 已渗透产研链路各个工种，但让这些能力沉淀为组织级的交付效率，仍是 AI Native 组织面临的重要问题。大型需求的成本，多半不在写代码，而在跨角色的反复对齐与验证断点。飞猪交付大脑的解法是打造一条超级流程：把冗长的交付链路收敛为需求对齐、Coding 实现、测试验收几个关键阶段，让 Agent 成为流程的第一公民，并串联整条链路。本次分享将拆解这条流程的设计、工程实现与真实效果。

![](/ai-knowledge-qoder/_imgs/7cb7073513f4ea89.png)

拥有 12 年前端与跨端研发经验，长期专注跨团队协同提效、跨端工程化，近期聚焦 AI2C 的用户侧应用及 AINative 的需求交付提效。
...
> 本文正文由程序自动抓取自公开网页/RSS，版权归原作者与来源站点所有；如有侵权请联系删除。原文出处：InfoQ 中文（https://www.infoq.cn/article/lRSUjSdeaHMzTTycosyT?utm_source=rss&utm_medium=article）。