...
tags:
  - AI
  - InfoQ 中文
excerpt: "DeepSeek 今天发布了 DeepSeek-V4.1-Flash。 DeepSeek-V4.1-Flash 是一款原生多模态 MoE 模型，支持最高 100 万 Token 上下文。模型拥有 55"
source_url: "https://www.infoq.cn/article/sbaJrAa8VTIRKIPCpKlo?utm_source=rss&utm_medium=article"
---
...
![](/ai-knowledge-qoder/_imgs/b95e79b3cf5bc695.png)
...
![](/ai-knowledge-qoder/_imgs/5fb37dee13be41eb.png)
...
真正的问题在于，一旦 SWA KV 丢失，过去要精确恢复它成本很高。V4.1 为此设计了 SWA Bounded Replay：不再追求数学意义上的完全重建，只重新计算最近 nwinn\_{win} 个 Token，用近似状态恢复 SWA。DeepSeek 表示，在内部测试中，这一近似恢复对回答质量的影响可以忽略。
...
[https://huggingface.co/deepseek-ai/DeepSeek-V4.1-Flash/blob/main/DeepSeek\_V41\_Tech\_Report.pdf](https://huggingface.co/deepseek-ai/DeepSeek-V4.1-Flash/blob/main/DeepSeek_V41_Tech_Report.pdf)


---

> 本文正文由程序自动抓取自公开网页/RSS，版权归原作者与来源站点所有；如有侵权请联系删除。原文出处：InfoQ 中文（https://www.infoq.cn/article/sbaJrAa8VTIRKIPCpKlo?utm_source=rss&utm_medium=article）。