...
不过，这里有一个很重要的概念需要区分：**“自动研究（Auto Research）”不等于 RSI。**前者意味着 AI 能够自动承担越来越多研究工作；后者则意味着，AI 不仅研究别的问题，还能够持续改进**创造和训练自身的系统**，由此形成一轮又一轮自我增强。

Recursive 目前做到的仍然属于前者。Socher 自己也把[已经公开的系统](https://www.linkedin.com/posts/richardsocher_ai-is-now-doing-our-ai-research-at-recursive-activity-7470861399276068864-b366)称为通往 RSI 的一个“里程碑”，或者“尤里卡机器的 0.1 版本”，而不是已经实现了 RSI。
...
> 本文正文由程序自动抓取自公开网页/RSS，版权归原作者与来源站点所有；如有侵权请联系删除。原文出处：InfoQ 中文（https://www.infoq.cn/article/da8jMox7ikdNmD2vYyTm?utm_source=rss&utm_medium=article）。