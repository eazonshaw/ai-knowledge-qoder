...
tags:
  - AI
  - InfoQ 中文
excerpt: "当 Agent 开始“吃数据”，传统湖仓不够用了：华为云重做 AI 时代数据基础设施 过去数据平台主要服务人、BI 系统和传统应用，如今，模型与 Agent 正在成为新的数据消费者。而数据消费主体的变"
source_url: "https://www.infoq.cn/article/IE4CYYwbLYYKSbg7lXfx?utm_source=rss&utm_medium=article"
---
...
> 本文正文由程序自动抓取自公开网页/RSS，版权归原作者与来源站点所有；如有侵权请联系删除。原文出处：InfoQ 中文（https://www.infoq.cn/article/IE4CYYwbLYYKSbg7lXfx?utm_source=rss&utm_medium=article）。