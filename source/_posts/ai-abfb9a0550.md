...
tags:
  - AI
  - InfoQ 中文
excerpt: "Jiuwen Symbiosis 是一个能懂人话、看得见物理世界、控制四肢执行的 Physical AI Agent。用户不需要示教，只需像指挥一个经验丰富的工人一样，用自然语言下任务，它就能自己完成"
source_url: "https://www.infoq.cn/article/BmyIPDkVKj11vspmB6su?utm_source=rss&utm_medium=article"
---
...
GitHub： [https://github.com/openJiuwen-ai/jiuwensymbiosis](https://github.com/openJiuwen-ai/jiuwensymbiosis)

GitCode： [https://gitcode.com/openJiuwen/jiuwensymbiosis](https://gitcode.com/openJiuwen/jiuwensymbiosis)
...
![](/ai-knowledge-qoder/_imgs/2c841ee100ad599b.jpg)
...
其中 Action Tool 所有动作均以原子化函数形式封装（如 move\_to\_xyzr()、gripper\_open()），每个动作独立、与环境解耦、与本体解耦，可自由组合为任意操作序列。相比端到端的小脑模型，原子化函数在执行层面具备更高的确定性、稳定性与成功率。
...
> 本文正文由程序自动抓取自公开网页/RSS，版权归原作者与来源站点所有；如有侵权请联系删除。原文出处：InfoQ 中文（https://www.infoq.cn/article/BmyIPDkVKj11vspmB6su?utm_source=rss&utm_medium=article）。